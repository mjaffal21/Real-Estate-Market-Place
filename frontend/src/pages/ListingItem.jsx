...
import { useGetListQuery } from "../slices/listApiSlice";
...
const ListingItem = () => {
  ...
  const { data: listing, isLoading, isError } = useGetListQuery(listingId);
  return (
    <main>
      ...
      {listing && !isLoading && !isError && (
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            {userInfo && listing.user !== userInfo._id && !contact && (
              <button
